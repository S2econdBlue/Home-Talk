...
CREATE TABLE `eachfeeitem` (
  ...
  CONSTRAINT `fk_oncascade_3` FOREIGN KEY (`boardNo`) REFERENCES `tradeboard` (`boardNo`) ON DELETE CASCADE
...
INSERT INTO `eachfeeitem` VALUES (71,'가스'),(71,'난방'),(71,'전기'),(72,'가스'),(72,'난방'),(72,'전기'),(74,'수도'),(75,'가스');
