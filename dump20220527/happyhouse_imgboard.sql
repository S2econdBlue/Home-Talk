...
CREATE TABLE `imgboard` (
  ...
  `save_path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  CONSTRAINT `fk_oncascade_4` FOREIGN KEY (`board_no`) REFERENCES `threadboard` (`no`) ON DELETE CASCADE
...
INSERT INTO `imgboard` VALUES (61,71,'622d6f6a77c76_origin.jpg','C:\\SSAFY\\관통\\final\\HappyHouse_boot\\src/main/resources/static/images/20220526/436064433050300.jpg','290748','n','2022-05-26 04:17:46',NULL),(62,71,'622d6f6addde6_origin.jpg','C:\\SSAFY\\관통\\final\\HappyHouse_boot\\src/main/resources/static/images/20220526/436064435047900.jpg','254365','n','2022-05-26 04:17:46',NULL);
...
-- Dump completed on 2022-05-27  6:01:03
